...
/**
 * Defines all possible navigation destinations in the application using
 * Kotlin Serialization for type safety.
 */
...
data object UriHistoryScreen : AppDestination {
    @Serializable data object NestedScreen1 : AppDestination
    @Serializable data object NestedScreen2 : AppDestination
    @Serializable data object NestedScreen3 : AppDestination
}
